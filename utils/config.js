...
var DOMAIN = "www.vickies.top";
var MINAPPTYPE="1";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="vickies"; //网站名称
var ABOUTID = 97; //wordpress网站"页面"的id,注意这个"页面"是wordpress的"页面"，不是"文章"
...
var ZANIMAGEURL = 'https://vickies.top/wp-content/uploads/2018/05/WechatIMG5.jpeg';//微信赞赏的图片链接，用于个人小程序的赞赏
...
var DOWNLOADFILEDOMAIN = [
    { id: 1, domain: 'www.vickies.top' },
    { id: 2, domain: 'vickies.top' },
    { id: 3, domain: 'www.Vickies.top' }
]
 //首页图标导航
...
var INDEXNAV = [
    { id: '1', name: 'Store', image: '../../images/shop.png', url: 'pages/shelf/shelf', redirecttype: 'miniapp', appid: 'wx55ea6098e41af5c4', extraData:'' },
    { id: '2', name: 'Rank', image: '../../images/ranking.png', url: '../hot/hot', redirecttype: 'apppage', appid: '', extraData:''},   
    { id: '3', name: 'Course', image: '../../images/app.png', url: '../list/list?categoryID=98', redirecttype: 'apppage', appid: '', extraData: '' },
   ]
